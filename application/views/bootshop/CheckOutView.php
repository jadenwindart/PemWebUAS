				...
				<div class="row">
					...
					<div class="span9">
						...
						<table class="table table-bordered">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<div class="input-append"><h5><?php echo $Order['qty']?></h5></div>
									</td>
						...
						<?php if($ProductOrder !== NULL && count($ProductOrder) != 0){?>
                            <a href="#checkout" role="button" data-toggle="modal" style="padding-right:0"><span class="btn btn-large btn-success">CheckOut</span></a>
                            <div id="checkout" class="modal hide fade in" tabindex="-1" role="dialog" aria-labelledby="login" aria-hidden="false" >
                                <div class="modal-header">
                                    <h3>Please Insert Your Password</h3>
                                </div>
                                <div class="modal-body">
                                    <?php echo form_open('Cart/Checkout',array('class'=>'form-horizontal'))?>
                                    <div class="control-group">
